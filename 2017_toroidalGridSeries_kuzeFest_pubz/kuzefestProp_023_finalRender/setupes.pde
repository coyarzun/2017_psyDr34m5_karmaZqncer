float _width = 1024, _height = 425;


void setupRsrcs(){
  gridBuffer = createGraphics(1024,425,P3D);
  guidesBuffer = createGraphics(1024,425,P3D);
  ringGuidesBuffer = createGraphics(1024,425,P3D);
  gridFxBuffer = createGraphics(1024,425,P3D);
  textBuffer = createGraphics(1024,425,P3D);
...
void setupSizes(){
  ...
  realWidth = 4096;
  realHeight = 1698;
  sizefactor = realSize?1:4;
  size(realWidth/sizefactor, realHeight/sizefactor, P3D);
  colorMode(HSB);
  textureWrap(REPEAT);
...
void setupColors() {
  ...
  guideFXColor = color(128, 196, 255);
}
void setupZeroes(){
  zero = new PVector(_width/2, 2*_height/3);
  left   = zero.x-_width/2;
  right  = zero.x+_width/2;
  top    = zero.y-2*_height/3; 
  bottom = zero.y+_height/3; 
}

void setupGuides() {
  guides = new ArrayList<Guide>();
  //guides.add( new Guide(-_width/2, -_height/2, _width/2, _height/2) );
  //guides.add( new Guide(left, top, right, bottom ));//diagonal
  //horizontales
  
  guides.add( new Guide(left, zero.y-2*_height/3, right, zero.y-2*_height/3) );//top
  guides.add( new Guide(left, zero.y-2*_height/3+16, right, zero.y-2*_height/3+16) );
  guides.add( new Guide(left, zero.y-2*_height/3+16+48, right, zero.y-2*_height/3+16+48) );
  guides.add( new Guide(left, zero.y-2*_height/3+16+48+8, right, zero.y-2*_height/3+16+48+8) );
  guides.add( new Guide(left, zero.y-2*_height/3+16+48+8+8, right, zero.y-2*_height/3+16+48+8+8) );
  guides.add( new Guide(left, zero.y-2*_height/3+16+48+8+8+10, right, zero.y-2*_height/3+16+48+8+8+10) );
  guides.add( new Guide(left, zero.y-2*_height/3+16+48+8+8+10+10, right, zero.y-2*_height/3+16+48+8+8+10+10) );
  guides.add( new Guide(left, zero.y-2*_height/3+16+48+8+8+10+10+8, right, zero.y-2*_height/3+16+48+8+8+10+10+8) );
  guides.add( new Guide(left, zero.y-2*_height/3+16+48+8+8+10+10+8+10, right, zero.y-2*_height/3+16+48+8+8+10+10+8+10) );//upper oval center
  guides.add( new Guide(left, zero.y-2*_height/3+16+48+8+8+10+10+8+10+12, right, zero.y-2*_height/3+16+48+8+8+10+10+8+10+12) );
  float top2 =  zero.y-2*_height/3+16+48+8+8+10+10+8+10+12+4;
...
void setupRingGuides() {
  ...
  ringGuides.add( new RingGuide(_width-v1, top3, rv) );//v1  
  ringGuides.add( new RingGuide(_width-v2, top3, rv) );//v2
  ringGuides.add( new RingGuide(_width-v3, top3, rv) );//v3 
}
